<template>
  <div @event="value = $event" class="footerStadistics">
    <span class="tittle"> Estadisticas:</span><br />
    <span>Total de tareas: {{ this.totalTasks }}</span
    ><br />
...
<script>
export default {
  inject: ["$todoLength", "$totalTasks"],
  computed: {
    todoLength() {
      return this.$todoLength();
    },
    totalTasks() {
